...
"use strict";
//user controlled circle. It moves based purely on its vx and vy properties
//although it can move in any direction, it moves separately on x and y each frame
//we can then make the circle move based on its angle and follow that angle
let circle = {
  x: 300,
  y: 300,
  size: 100,
